...
int func1(int y){
    ...
    char* string;
    		// 10 byte memory space malloced in each of 10 char * pointer
    for(f = 1; f<=1000; f++){
        ...
        //10 char * alloted
        int x;
        string = (char*)malloc(sizeof(char)*3000);
        ...
        // printf("here\n" );
        sprintf((string+2998), "%d",y);
        *(string+2999) = '\0';					// Null byte placed  at the end of string.
